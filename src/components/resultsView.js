...
resultView.innerHTML =`
    <div id="resultsView" class="view hidden">
        <button id="buttonBack" class="btn btn-warning">< Volver a la Búsqueda</button>
...
export function returnToSearch() {
    console.log("Regresando a la búsqueda");
    showView('searchView');
}

//row row-cols-2 Esto va en el result-container